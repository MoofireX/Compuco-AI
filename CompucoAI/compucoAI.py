...
class AIWorker(QThread):
    ...
    def __init__(self, prompt, system, key):
        super().__init__()
        self.prompt = prompt
        QApplication.instance().prompt_global = self.prompt
        self.system = system
        self.key = key
...
class ChatWindow(QtWidgets.QMainWindow):
    ...
    def ai_chat(self):
        self.system = platform.system()
        self.prompt_global = QApplication.instance().prompt_global
        try:
            key = os.environ.get("GOOGLE_API")
